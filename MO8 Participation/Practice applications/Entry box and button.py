...
e.pack()
# e.insert (0, "Enter your name")   # this part, if added back in, will put a default message in the text entry box. Run the two versions of this program to see the difference.
